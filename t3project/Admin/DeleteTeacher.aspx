        ...
        <table style="font-size:100%; width:100%;">
            ...
            <tr>
              <td align="center">
                 ...
                 <asp:Button CssClass ="button_function" style ="background:#dc3545; border:1px solid #dc3545; margin-left:10px;" ID="btnDelete" runat="server" Text="삭제하기" onClick="btnDelete_Click"/>
            </td>
           </tr>
         </table>
